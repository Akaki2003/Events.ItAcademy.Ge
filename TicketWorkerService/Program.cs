...
static IHostBuilder CreateHostBuilder(string[] args) =>
    ...
    .ConfigureServices((hostContext, services) =>
    {
        ...
        services.AddDbContext<EventsItAcademyContext>(options => options.UseSqlServer(hostContext.Configuration.GetConnectionString(nameof(ConnectionStrings.DefaultConnection))));
