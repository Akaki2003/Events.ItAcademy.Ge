...
namespace Events.ItAcademy.Persistence.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReserveTimeLengthInMinutes = table.Column<int>(type: "int", nullable: false),
                    EditEventAfterUploadInDays = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventSetups", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArchivedEvents_AspNetUsers_UserId",
                        column: x => x.UserId,
